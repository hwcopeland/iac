//#region node_modules/molstar/lib/mol-data/util/array.js
/**
...
function arrayFind(array, f) {
	for (let i = 0, _i = array.length; i < _i; i++) if (f(array[i])) return array[i];
}
...
function createRangeArray(start, end, ctor) {
	...
	for (let i = 0; i < len; i++) array[i] = i + start;
	return array;
}
function arrayPickIndices(array, indices) {
	const ret = new (arrayGetCtor(array))(indices.length);
	for (let i = 0, _i = indices.length; i < _i; i++) ret[i] = array[indices[i]];
	return ret;
}
...
//#endregion
export { iterableToArray as i, arrayPickIndices as n, createRangeArray as r, arrayFind as t };

//# sourceMappingURL=array-DTSBKlr9.js.map