...
const structure_query_1 = require("./structure-query.js");
const objects_1 = require("../objects.js");
const structure_selection_query_1 = require("./structure-selection-query.js");
...
function updateStructureComponent(a, b, oldParams, newParams, cache) {
    ...
    switch (newParams.type.name) {
        case 'static': {
            ...
            if (!b.data.model)
                return mol_state_1.StateTransformer.UpdateResult.Unchanged; // .model can be undefined, when a substructure is empty -> doesn't need remapping
