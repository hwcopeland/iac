...
const normalize_frag_1 = require("../../../mol-gl/shader/compute/color-smoothing/normalize.frag.js");
...
const accumulate_frag_1 = require("../../../mol-gl/shader/compute/color-smoothing/accumulate.frag.js");
const accumulate_vert_1 = require("../../../mol-gl/shader/compute/color-smoothing/accumulate.vert.js");
const compat_1 = require("../../../mol-gl/webgl/compat.js");
...
function calcTextureMeshColorSmoothing(input, options, webgl, texture) {
    ...
    if (!isInstanceType) {
        ...
        input.transformBuffer = new Float32Array(linear_algebra_1.Mat4.id);
    }
...
function applyTextureMeshColorSmoothing(values, options, webgl, colorTexture) {
...
function applyTextureMeshOverpaintSmoothing(values, options, webgl, colorTexture) {
...
function applyTextureMeshTransparencySmoothing(values, options, webgl, colorTexture) {
...
function applyTextureMeshEmissiveSmoothing(values, options, webgl, colorTexture) {
...
function applyTextureMeshSubstanceSmoothing(values, options, webgl, colorTexture) {
