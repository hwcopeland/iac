...
exports.createVertexSize = createVertexSize;
exports.createVertexInstanceSize = createVertexInstanceSize;
...
const geometry_1 = require("./geometry.js");
...
function createUniformSize(locationIt, sizeFn, sizeData) {
    locationIt.reset();
    const location = locationIt.hasNext ? locationIt.move().location : location_1.NullLocation;
