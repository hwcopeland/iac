...
exports.hashFnv256a = hashFnv256a;
exports.hashFnv256o = hashFnv256o;
exports.hashMurmur32o = hashMurmur32o;
exports.hashMurmur128o = hashMurmur128o;
exports.murmurHash3_32 = murmurHash3_32;
exports.murmurHash3_128_fromBytes = murmurHash3_128_fromBytes;
exports.murmurHash3_128 = murmurHash3_128;
exports.mortonOrder3d = mortonOrder3d;
exports.invertMortonOrder3d = invertMortonOrder3d;
 ...
 */
function hashFnv256a(array, out) {
    out.set(Fnv256Base);
    for (let i = 0, il = array.length; i < il; ++i) {
        // XOR with input byte
        out[0] ^= array[i] & 0xff;
 ...
 * 32-bit Murmur hash
 */
function hashMurmur32o(obj, seed = 42) {
...
function invertMortonOrder3d(code) {
    let x = 0;
    let y = 0;
    let z = 0;
    for (let i = 0; i < 21; ++i) {
