...
function getInterUnitBondLineBuilderProps(structure, theme, props) {
    ...
    return {
        ...
        style: (edgeIndex) => {
            ...
            if (types_1.BondType.is(f, types_1.BondType.Flag.MetallicCoordination)) {
                return metalDashed ? link_1.LinkStyle.Dashed : link_1.LinkStyle.Solid;
            }
            else if (types_1.BondType.is(f, types_1.BondType.Flag.HydrogenBond)) {
