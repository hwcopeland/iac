...
exports.Unit = void 0;
const symmetry_operator_1 = require("../../../mol-math/geometry/symmetry-operator.js");
const model_1 = require("../model.js");
const geometry_1 = require("../../../mol-math/geometry.js");
const bonds_1 = require("./unit/bonds.js");
const atomic_1 = require("../model/properties/atomic.js");
const mol_util_1 = require("../../../mol-util/index.js");
const rings_1 = require("./unit/rings.js");
const int_1 = require("../../../mol-data/int.js");
const util_1 = require("../../../mol-data/util.js");
const polymer_1 = require("./util/polymer.js");
const principal_axes_1 = require("./util/principal-axes.js");
const boundary_1 = require("../../../mol-math/geometry/boundary.js");
...
const element_set_intra_bond_cache_1 = require("./unit/bonds/element-set-intra-bond-cache.js");
const symmetry_1 = require("../../../mol-model-formats/structure/property/symmetry.js");
const resonance_1 = require("./unit/resonance.js");
var Unit;
(function (Unit) {
    let Kind;
    (function (Kind) {
    ...
    function create(id, invariantId, chainGroupId, traits, kind, model, operator, elements, props) {
        switch (kind) {
            case Kind.Atomic: return new Atomic(id, invariantId, chainGroupId, traits, model, elements, symmetry_operator_1.SymmetryOperator.createMapping(operator, model.atomicConformation, getAtomicRadiusFunc(model)), props !== null && props !== void 0 ? props : AtomicProperties());
    ...
    function getAtomicRadiusFunc(model) {
        ...
        return (i) => (0, atomic_1.VdwRadius)(type_symbol(i));
    }
    ...
    class Atomic {
        ...
        remapModel(model, dynamicBonds, props) {
            ...
            const conformation = (this.model.atomicConformation !== model.atomicConformation || operator !== this.conformation.operator)
                ? symmetry_operator_1.SymmetryOperator.createMapping(operator, model.atomicConformation, getAtomicRadiusFunc(model))
                : this.conformation;
        ...
        get boundary() {
            ...
            const radius = fast ? undefined : model_1.Model.getAtomicRadii(this.model);
            this.props.boundary = fast
                ? (0, boundary_1.getFastBoundary)({ x, y, z, radius, indices: this.elements })
                : (0, boundary_1.getBoundary)({ x, y, z, radius, indices: this.elements });
            return this.props.boundary;
        }
        get lookup3d() {
