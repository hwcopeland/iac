...
const root_structure_1 = require("../helpers/root-structure.js");
const structure_component_1 = require("../helpers/structure-component.js");
const structure_query_1 = require("../helpers/structure-query.js");
const structure_selection_query_1 = require("../helpers/structure-selection-query.js");
const objects_1 = require("../objects.js");
const parser_4 = require("../../mol-io/reader/mol/parser.js");
const mol_1 = require("../../mol-model-formats/structure/mol.js");
const cif_core_1 = require("../../mol-model-formats/structure/cif-core.js");
const cube_1 = require("../../mol-model-formats/structure/cube.js");
const parser_5 = require("../../mol-io/reader/mol2/parser.js");
const mol2_1 = require("../../mol-model-formats/structure/mol2.js");
const parser_6 = require("../../mol-io/reader/xtc/parser.js");
const xtc_1 = require("../../mol-model-formats/structure/xtc.js");
const parser_7 = require("../../mol-io/reader/xyz/parser.js");
const xyz_1 = require("../../mol-model-formats/structure/xyz.js");
const schema_1 = require("../../mol-io/reader/lammps/schema.js");
const parser_8 = require("../../mol-io/reader/lammps/data/parser.js");
const lammps_data_1 = require("../../mol-model-formats/structure/lammps-data.js");
const parser_9 = require("../../mol-io/reader/lammps/traj/parser.js");
const lammps_trajectory_1 = require("../../mol-model-formats/structure/lammps-trajectory.js");
const parser_10 = require("../../mol-io/reader/sdf/parser.js");
const sdf_1 = require("../../mol-model-formats/structure/sdf.js");
const type_helpers_1 = require("../../mol-util/type-helpers.js");
const parser_11 = require("../../mol-io/reader/trr/parser.js");
const trr_1 = require("../../mol-model-formats/structure/trr.js");
const parser_12 = require("../../mol-io/reader/nctraj/parser.js");
const nctraj_1 = require("../../mol-model-formats/structure/nctraj.js");
const prmtop_1 = require("../../mol-model-formats/structure/prmtop.js");
const top_1 = require("../../mol-model-formats/structure/top.js");
...
const TrajectoryFromPDB = objects_1.PluginStateTransform.BuiltIn({
    ...
    to: objects_1.PluginStateObject.Molecule.Trajectory,
    params: {
        variant: param_definition_1.ParamDefinition.Select('pdb', param_definition_1.ParamDefinition.arrayToOptions(['pdb', 'pdbqt', 'pqr'])),
    }
})({
    apply({ a, params }) {
        return mol_task_1.Task.create('Parse PDB', async (ctx) => {
            const parsed = await (0, parser_3.parsePDB)(a.data, a.label, params.variant).runInContext(ctx);
            if (parsed.isError)
                throw new Error(parsed.message);
...
const TransformStructureConformation = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply({ a, params }) {
        const center = (0, helpers_1.transformParamsNeedCentroid)(params.transform) ? a.data.boundary.sphere.center : linear_algebra_1.Vec3.unit;
...
const StructureInstances = objects_1.PluginStateTransform.BuiltIn({
    ...
    to: objects_1.PluginStateObject.Molecule.Structure,
    params: {
        transforms: param_definition_1.ParamDefinition.ObjectList({ transform: helpers_1.TransformParam }, () => 'Transform')
    },
})({
    canAutoUpdate() {
        return true;
    ...
    apply({ a, params }) {
        const center = params.transforms.some(t => (0, helpers_1.transformParamsNeedCentroid)(t.transform)) ? a.data.boundary.sphere.center : linear_algebra_1.Vec3.unit;
        const instances = params.transforms.map(t => (0, helpers_1.getTransformFromParams)(t.transform, center));
        if (!instances.length) {
            return a;
        }
        const s = structure_1.Structure.instances(a.data, instances);
        return new objects_1.PluginStateObject.Molecule.Structure(s, { label: a.label, description: `${a.description} [Instanced]` });
    },
    dispose({ b }) {
        b === null || b === void 0 ? void 0 : b.data.customPropertyDescriptors.dispose();
    }
});
exports.StructureInstances = StructureInstances;
