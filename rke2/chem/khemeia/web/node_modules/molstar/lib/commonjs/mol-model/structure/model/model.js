...
const uuid_1 = require("../../../mol-util/uuid.js");
const atomic_1 = require("./properties/atomic.js");
const util_1 = require("./util.js");
const linear_algebra_1 = require("../../../mol-math/linear-algebra.js");
const coordinates_1 = require("../coordinates.js");
...
const parser_1 = require("../../../mol-model-formats/structure/basic/parser.js");
...
const trajectory_1 = require("../trajectory.js");
const types_1 = require("./types.js");
const secondary_structure_1 = require("../../../mol-model-formats/structure/property/secondary-structure.js");
{ }
var Model;
(function (Model) {
    ...
    function getAtomicRadii(model) {
        ...
        for (let i = 0; i < nAtoms; i++) {
            radii[i] = (0, atomic_1.VdwRadius)(type_symbol(i));
        }
        ...
        if (coarseGrained === undefined) {
            ...
            for (let i = 0; i < atomCount; ++i) {
                ...
                if (!hasSC1 && atomName === 'SC1')
                    hasSC1 = true;
                if (!hasTrace && types_1.TraceAtoms.has(atomName))
                    hasTrace = true;
