...
const volume_representation_params_1 = require("../helpers/volume-representation-params.js");
const object_1 = require("../../mol-util/object.js");
const property_1 = require("../../mol-model-formats/volume/property.js");
const util_1 = require("../../mol-plugin/behavior/dynamic/volume-streaming/util.js");
...
exports.Ccp4Provider = (0, provider_1.DataFormatProvider)({
    ...
    parse: async (plugin, data, params) => {
        ...
        const volume = format
            .apply(transforms_1.StateTransforms.Volume.VolumeFromCcp4, { entryId: params === null || params === void 0 ? void 0 : params.entryId })
            .apply(transforms_1.StateTransforms.Volume.CustomVolumeProperties);
...
exports.Dsn6Provider = (0, provider_1.DataFormatProvider)({
    ...
    parse: async (plugin, data, params) => {
        ...
        const volume = format
            .apply(transforms_1.StateTransforms.Volume.VolumeFromDsn6, { entryId: params === null || params === void 0 ? void 0 : params.entryId })
            .apply(transforms_1.StateTransforms.Volume.CustomVolumeProperties);
        await format.commit({ revertOnError: true });
        await tryObtainRecommendedIsoValue(plugin, volume.selector.data);
        return { format: format.selector, volume: volume.selector };
...
exports.DxProvider = (0, provider_1.DataFormatProvider)({
    ...
    parse: async (plugin, data, params) => {
        ...
        const volume = format
            .apply(transforms_1.StateTransforms.Volume.VolumeFromDx, { entryId: params === null || params === void 0 ? void 0 : params.entryId })
            .apply(transforms_1.StateTransforms.Volume.CustomVolumeProperties);
...
exports.CubeProvider = (0, provider_1.DataFormatProvider)({
    ...
    parse: async (plugin, data, params) => {
        ...
        const volume = format
            .apply(transforms_1.StateTransforms.Volume.VolumeFromCube, { entryId: params === null || params === void 0 ? void 0 : params.entryId })
            .apply(transforms_1.StateTransforms.Volume.CustomVolumeProperties);
        const structure = format
            ...
            .apply(transforms_1.StateTransforms.Model.CustomModelProperties)
            .apply(transforms_1.StateTransforms.Model.StructureFromModel)
            .apply(transforms_1.StateTransforms.Model.CustomStructureProperties);
        await format.commit({ revertOnError: true });
        await tryObtainRecommendedIsoValue(plugin, volume.selector.data);
    ...
    parse: async (plugin, data, params) => {
        ...
        for (const block of blocks) {
            ...
            if (((_a = block.categories['volume_data_3d_info']) === null || _a === void 0 ? void 0 : _a.rowCount) > 0) {
                const volume = b
                    .apply(transforms_1.StateTransforms.Volume.VolumeFromDensityServerCif, { blockHeader: block.header, entryId })
                    .apply(transforms_1.StateTransforms.Volume.CustomVolumeProperties);
...
exports.SegcifProvider = (0, provider_1.DataFormatProvider)({
    ...
    parse: async (plugin, data) => {
        ...
        for (const block of blocks) {
            ...
            if (((_a = block.categories['volume_data_3d_info']) === null || _a === void 0 ? void 0 : _a.rowCount) > 0) {
                const volume = b
                    .apply(transforms_1.StateTransforms.Volume.VolumeFromSegmentationCif, { blockHeader: block.header })
                    .apply(transforms_1.StateTransforms.Volume.CustomVolumeProperties);
                volumes.push(volume.selector);
            }
        }
