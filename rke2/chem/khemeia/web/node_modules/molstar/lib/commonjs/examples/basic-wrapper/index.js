...
const coloring_1 = require("./coloring.js");
const controls_1 = require("./controls.js");
const custom_theme_1 = require("./custom-theme.js");
require("./index.html");
require("./tm-align.html");
...
class BasicWrapper {
            ...
            settings: {
                trackball: {
                    ...
                    animate: trackball.animate.name === 'spin'
                        ? { name: 'off', params: {} }
                        : { name: 'spin', params: { speed: 0.1, axis: vec3_1.Vec3.create(0, -1, 0) } }
                }
            }
        });
    ...
    tmAlign(pdbId1, chain1, pdbId2, chain2, color1, color2) {
        return (0, superposition_1.tmAlignStructures)(this.plugin, pdbId1, chain1, pdbId2, chain2, color1, color2);
    }
    /**
     ...
     * @param color2 - Optional color for second structure (hex, default red)
     */
    loadStructures(pdbId1, chain1, pdbId2, chain2, color1, color2) {
        return (0, superposition_1.loadStructuresNoAlignment)(this.plugin, pdbId1, chain1, pdbId2, chain2, color1, color2);
    }
    /**
     ...
     * @param color2 - Optional color for second structure (hex, default red)
     */
    sequenceAlign(pdbId1, chain1, pdbId2, chain2, color1, color2) {
        return (0, superposition_1.sequenceAlignStructures)(this.plugin, pdbId1, chain1, pdbId2, chain2, color1, color2);
    }
}
