...
const volume_streaming_1 = require("./load-extensions/volume-streaming.js");
...
function molstarTreeToEntry(plugin, tree, animation, metadata, options) {
    ...
    if (options === null || options === void 0 ? void 0 : options.keepCamera) {
        ...
        snapshot.camera = (0, camera_1.createPluginStateSnapshotCamera)(plugin, context, { previousTransitionDurationMs: metadata.previousTransitionDurationMs, ignoreCameraOrientation: true });
    }
    else {
        // fully load camera
        snapshot.camera = (0, camera_1.createPluginStateSnapshotCamera)(plugin, context, { previousTransitionDurationMs: metadata.previousTransitionDurationMs });
    }
...
const MolstarLoadingActions = {
    ...
    trajectory(updateParent, node) {
        ...
        switch (format) {
            ...
            case 'pdb':
            case 'pdbqt':
                return load_generic_1.UpdateTarget.apply(updateParent, model_1.TrajectoryFromPDB, { variant: format });
            case 'gro':
...
exports.BuiltinLoadingExtensions = [
    ...
    volume_streaming_1.VolumeStreamingExtension,
];
