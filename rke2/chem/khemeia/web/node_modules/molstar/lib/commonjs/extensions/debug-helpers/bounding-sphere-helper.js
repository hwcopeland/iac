...
exports.BoundingSphereHelper = exports.BoundingSphereHelperParams = void 0;
...
const geometry_2 = require("../../mol-geo/geometry/geometry.js");
exports.BoundingSphereHelperParams = {
...
class BoundingSphereHelper {
    constructor(ctx, parent, props) {
        ...
        this.parent = parent;
        this._props = { ...param_definition_1.ParamDefinition.getDefaultValues(exports.BoundingSphereHelperParams), ...props };
    }
    update() {
