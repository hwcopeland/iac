...
import { StructureSelectionHistoryEntry } from '../../mol-plugin-state/manager/structure/selection.js';
import { PluginStateObject } from '../../mol-plugin-state/objects.js';
import { StateObjectCell, StateObjectRef } from '../../mol-state/index.js';
...
export declare class StructureSuperpositionControls extends CollapsableControls {
    defaultState(): {
        ...
        brand: {
            accent: "gray";
            svg: typeof import("../controls/icons.js").FlipToFrontSvg;
        };
        isHidden: boolean;
    };
...
export declare class SuperpositionControls extends PurePluginUIComponent<{}, SuperpositionControlsState> {
    ...
    componentDidMount(): void;
    get selection(): import("../../mol-plugin-state/manager/structure/selection.js").StructureSelectionManager;
    ...
    superposeTMAlign: () => Promise<void>;
    cameraReset(): Promise<void>;
    toggleByChains: () => void;
    toggleByAtoms: () => void;
    toggleByTMAlign: () => void;
    toggleOptions: () => void;
    ...
    addByTMAlign(): import("react/jsx-runtime").JSX.Element;
