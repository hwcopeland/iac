...
exports.BondParams = {
    ...
    metalCoordination: param_definition_1.ParamDefinition.Select('dashed', param_definition_1.ParamDefinition.arrayToOptions(['dashed', 'solid'])),
};
...
function getIntraBondLoci(pickingId, structureGroup, id) {
    ...
    if (id === objectId) {
        ...
        if (groupId === picking_1.PickingId.Null) {
            const indices = int_1.OrderedSet.ofRange(0, unit.elements.length);
...
function getInterBondLoci(pickingId, structure, id) {
    ...
    if (id === objectId) {
        const { target } = structure;
        if (groupId === picking_1.PickingId.Null) {
            return structure_1.Structure.Loci(target);
        }
        else {
