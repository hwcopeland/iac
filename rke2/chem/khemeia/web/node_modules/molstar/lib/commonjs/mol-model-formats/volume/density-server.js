...
function volumeFromDensityServerData(source, params) {
    return mol_task_1.Task.create('Create Volume', async (ctx) => {
        ...
        const cell = geometry_1.SpacegroupCell.create(info.spacegroup_number.value(0) || 'P 1', linear_algebra_1.Vec3.ofArray(info.spacegroup_cell_size.value(0)), linear_algebra_1.Vec3.scale(linear_algebra_1.Vec3.zero(), linear_algebra_1.Vec3.ofArray(info.spacegroup_cell_angles.value(0)), Math.PI / 180));
        ...
        return {
            ...
            grid: {
                ...
                periodicity: linear_algebra_1.Vec3.isInteger(dimensions) ? 'xyz' : 'none',
            },
