 ...
 */
import { IntMap, Iterator } from '../../../mol-data/int.js';
...
import { InterUnitBonds } from './unit/bonds.js';
import { ResidueIndex, EntityIndex } from '../model/indexing.js';
import { Carbohydrates } from './carbohydrates/data.js';
import { Coordination } from './coordination/data.js';
...
import { ElementSymbol } from '../model/types.js';
...
import { IntraUnitBondMapping, SerialMapping } from './mapping.js';
...
declare namespace Structure {
    ...
    function instances(s: Structure, transforms: Mat4[]): Structure;
    ...
    type Index = number;
    const Index: import("../../../mol-model-props/common/custom-property.js").CustomProperty.Provider<Structure, {
        value: import("../../../mol-util/param-definition.js").ParamDefinition.Value<number | undefined>;
    }, number | undefined>;
    type MaxIndex = number;
    const MaxIndex: import("../../../mol-model-props/common/custom-property.js").CustomProperty.Provider<Structure, {
        value: import("../../../mol-util/param-definition.js").ParamDefinition.Value<number | undefined>;
    }, number | undefined>;
