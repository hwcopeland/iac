...
const sifts_mapping_1 = require("../../mol-model-props/sequence/sifts-mapping.js");
const structure_1 = require("../../mol-model/structure.js");
const superposition_1 = require("../../mol-model/structure/structure/util/superposition.js");
const superposition_sifts_mapping_1 = require("../../mol-model/structure/structure/util/superposition-sifts-mapping.js");
const tm_align_1 = require("../../mol-model/structure/structure/util/tm-align.js");
...
const parameters_1 = require("../controls/parameters.js");
const selection_1 = require("./selection.js");
...
class SuperpositionControls extends base_1.PurePluginUIComponent {
    constructor() {
        ...
        this.superposeTMAlign = async () => {
            ...
            const pivot = this.plugin.managers.structure.hierarchy.findStructure((_a = locis[0]) === null || _a === void 0 ? void 0 : _a.structure);
            const coordinateSystem = (_c = (_b = pivot === null || pivot === void 0 ? void 0 : pivot.transform) === null || _b === void 0 ? void 0 : _b.cell.obj) === null || _c === void 0 ? void 0 : _c.data.coordinateSystem;
            const tmAlignTask = mol_task_1.Task.create('TM-align Superposition', async (ctx) => {
                const eA = entries[0];
                for (let i = 1, il = locis.length; i < il; ++i) {
                    if (ctx.shouldUpdate)
                        await ctx.update(`Superposing pair ${i} of ${il - 1}...`);
                    const eB = entries[i];
                    const result = (0, tm_align_1.tmAlign)(locis[0], locis[i]);
        ...
        this.toggleByTMAlign = () => this.setState({ action: this.state.action === 'byTMAlign' ? void 0 : 'byTMAlign' });
    ...
    addByTMAlign() {
        const entries = this.chainEntries;
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [entries.length > 0 && (0, jsx_runtime_1.jsx)("div", { className: 'msp-control-offset', children: entries.map((e, i) => this.lociEntry(e, i)) }), entries.length < 2 && (0, jsx_runtime_1.jsx)("div", { className: 'msp-control-offset msp-help-text', children: (0, jsx_runtime_1.jsxs)("div", { className: 'msp-help-description', children: [(0, jsx_runtime_1.jsx)(icons_1.Icon, { svg: icons_1.HelpOutlineSvg, inline: true }), "Add 2 or more selections", this.toggleHint(), " from separate structures. Selections must be limited to single polymer chains. TM-align performs structure-based alignment independent of sequence."] }) }), entries.length > 1 && (0, jsx_runtime_1.jsx)(common_1.Button, { title: 'Superpose structures using TM-align (structure-based alignment).', className: 'msp-btn-commit msp-btn-commit-on', onClick: this.superposeTMAlign, style: { marginTop: '1px' }, children: "TM-align Superpose" })] });
    }
