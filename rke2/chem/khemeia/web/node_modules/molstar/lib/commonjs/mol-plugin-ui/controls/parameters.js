...
const action_menu_1 = require("./action-menu.js");
const color_2 = require("./color.js");
const common_1 = require("./common.js");
const icons_1 = require("./icons.js");
const legend_1 = require("./legend.js");
const line_graph_component_1 = require("./line-graph/line-graph-component.js");
const slider_1 = require("./slider.js");
...
function TextCtrl({ props, placeholder, update }) {
    ...
    const onChange = (e) => {
        if (composition || props.param.disableInteractiveUpdates)
    ...
    if (props.param.multiline) {
        return (0, jsx_runtime_1.jsx)("div", { className: 'msp-control-text-area-wrapper', children: (0, jsx_runtime_1.jsx)("textarea", { value: value !== null && value !== void 0 ? value : '', placeholder: placeholder, disabled: props.isDisabled, onChange: onChange, onBlur: onBlur, onKeyDown: onKeyDown, onCompositionStart: () => setComposition(true), onCompositionEnd: onCompositionEnd }) });
    }
    else {
        return (0, jsx_runtime_1.jsx)("input", { type: 'text', value: value !== null && value !== void 0 ? value : '', placeholder: placeholder, disabled: props.isDisabled, onChange: onChange, onBlur: onBlur, onKeyDown: onKeyDown, onCompositionStart: () => setComposition(true), onCompositionEnd: onCompositionEnd });
    }
}
...
class SelectControl extends React.PureComponent {
    ...
    renderControl() {
        ...
        const icon = this.props.param.cycle
            ...
            : void 0;
        return (0, jsx_runtime_1.jsx)(common_1.ToggleButton, { disabled: this.props.isDisabled, style: { textAlign, overflow: 'hidden', textOverflow: 'ellipsis' }, label: label, title: label, icon: icon, toggle: toggle, isSelected: this.state.showOptions, className: 'msp-select-toggle' });
    }
    renderAddOn() {
...
const colorGradientInterpolated = (0, memoize_1.memoize1)(utils_1.getColorGradient);
const colorGradientBanded = (0, memoize_1.memoize1)(utils_1.getColorGradientBanded);
...
function createColorListHelpers() {
    ...
    return {
        ColorPresets: {
            all: action_menu_1.ActionMenu.createItemsFromSelectOptions(lists_1.ColorListOptions, { addOn, description: o => o[3] }),
            scale: action_menu_1.ActionMenu.createItemsFromSelectOptions(lists_1.ColorListOptionsScale, { addOn, description: o => o[3] }),
            set: action_menu_1.ActionMenu.createItemsFromSelectOptions(lists_1.ColorListOptionsSet, { addOn, description: o => o[3] })
        },
...
class Vec3Control extends React.PureComponent {
    ...
    render() {
        ...
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(common_1.ControlRow, { label: label, control: (0, jsx_runtime_1.jsx)("button", { onClick: this.toggleExpanded, disabled: this.props.isDisabled, children: (0, jsx_runtime_1.jsx)("div", { title: value, className: 'msp-no-overflow', style: { display: 'block' }, children: value }) }) }), this.state.isExpanded && (0, jsx_runtime_1.jsx)("div", { className: 'msp-control-offset', children: (0, jsx_runtime_1.jsx)(ParameterControls, { params: this.components, values: v, onChange: this.componentChange, onEnter: this.props.onEnter }) })] });
    }
}
...
class Mat4Control extends React.PureComponent {
    ...
    render() {
        ...
        const label = this.props.param.label || (0, string_1.camelCaseToWords)(this.props.name);
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(common_1.ControlRow, { label: label, control: (0, jsx_runtime_1.jsx)("button", { onClick: this.toggleExpanded, disabled: this.props.isDisabled, children: (0, jsx_runtime_1.jsx)("div", { className: 'msp-no-overflow', style: { display: 'block' }, children: '4\u00D74 Matrix' }) }) }), this.state.isExpanded && (0, jsx_runtime_1.jsxs)("div", { className: 'msp-control-offset', children: [this.grid, (0, jsx_runtime_1.jsx)(ParameterControls, { params: this.components, values: v, onChange: this.componentChange, onEnter: this.props.onEnter })] })] });
    }
}
...
class GroupControl extends React.PureComponent {
    ...
    pivoted() {
        ...
        if (!this.state.isExpanded) {
            return (0, jsx_runtime_1.jsxs)("div", { className: 'msp-mapped-parameter-group', children: [ctrl, (0, jsx_runtime_1.jsx)(common_1.IconButton, { svg: icons_1.TuneSvg, onClick: this.toggleExpanded, toggleState: this.state.isExpanded, title: `More Options`, style: { opacity: 0.7 } })] });
        }
    ...
    render() {
        ...
        if (param.type === 'group' && !param.isFlat) {
            if (!this.areParamsEmpty(param.params)) {
                return (0, jsx_runtime_1.jsxs)("div", { className: 'msp-mapped-parameter-group', children: [Select, (0, jsx_runtime_1.jsx)(common_1.IconButton, { svg: icons_1.TuneSvg, onClick: this.toggleExpanded, toggleState: this.state.isExpanded, title: `${label} Properties`, style: { opacity: this.state.isExpanded ? undefined : 0.7 } }), this.state.isExpanded && (0, jsx_runtime_1.jsx)(GroupControl, { inMapped: true, param: param, value: value.params, name: value.name, onChange: this.onChangeParam, onEnter: this.props.onEnter, isDisabled: this.props.isDisabled })] });
            }
            return Select;
        }
