        ...
        return mol_task_1.Task.create('ShapeRepresentation.create', async (runtime) => {
            ...
            if (updateState.createNew) {
                ...
                if (updateState.createGeometry) {
                    ...
                    mol_util_1.ValueCell.updateIfChanged(_renderObject.values.uGroupCount, locationIt.groupCount);
                }
                ...
                if (updateState.updateSize) {
                    ...
                    if ('uSize' in _renderObject.values) {
                        ...
                        (0, size_data_1.createSizes)(locationIt, positionIt, _theme.size, _renderObject.values);
                    }
                }
