...
import { Lookup3D } from '../../../mol-math/geometry.js';
import { IntraUnitBonds } from './unit/bonds.js';
import { CoarseElements, CoarseSphereConformation, CoarseGaussianConformation } from '../model/properties/coarse.js';
import { BitFlags } from '../../../mol-util/index.js';
import { UnitRings } from './unit/rings.js';
import { StructureElement } from './element.js';
import { ChainIndex, ResidueIndex, ElementIndex } from '../model/indexing.js';
...
import { UnitResonance } from './unit/resonance.js';
/**
...
declare namespace Unit {
    ...
    export function conformationId(unit: Unit): import("../../../mol-util/index.js").UUID;
    ...
    export function getModelConformationOfKind(kind: Unit.Kind, model: Model): import("../model/properties/atomic.js").AtomicConformation | CoarseSphereConformation | CoarseGaussianConformation;
    export function getConformation(u: Unit): import("../model/properties/atomic.js").AtomicConformation | CoarseSphereConformation | CoarseGaussianConformation;
    export function getModelHierarchyOfKind(kind: Unit.Kind, model: Model): import("../model/properties/atomic.js").AtomicHierarchy | CoarseElements;
    export function getHierarchy(u: Unit): import("../model/properties/atomic.js").AtomicHierarchy | CoarseElements;
    export {};
}
export { Unit };
