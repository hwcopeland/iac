...
import { Cage } from '../../primitive/cage.js';
...
export declare namespace StripLinesBuilder {
    function create(initialCount?: number, chunkSize?: number, lines?: Lines): StripLinesBuilder;
}
