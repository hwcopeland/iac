...
exports.CameraControls = exports.CameraAxisHelper = exports.FocusLoci = exports.NoPrimaryFocusLociBindings = exports.DefaultFocusLociBindings = exports.DefaultClickResetCameraOnEmptySelectMode = exports.DefaultClickResetCameraOnEmpty = void 0;
...
exports.NoPrimaryFocusLociBindings = {
    clickCenterFocus: (0, binding_1.Binding)([
        Trigger(B.Flag.Secondary, M.create()),
        Trigger(B.Flag.Primary, M.create({ control: true })),
        Trigger(B.Flag.Trigger),
    ...
    ctor: class extends behavior_1.PluginBehavior.Handler {
        register() {
            this.subscribeObservable(this.ctx.behaviors.interaction.click, ({ current, button, modifiers }) => {
                ...
                const snapshotKey = (_f = (_e = (_d = (_c = current.repr) === null || _c === void 0 ? void 0 : _c.props) === null || _d === void 0 ? void 0 : _d.snapshotKey) === null || _e === void 0 ? void 0 : _e.trim()) !== null && _f !== void 0 ? _f : '';
                const markdownCommands = (_h = (_g = current.repr) === null || _g === void 0 ? void 0 : _g.props) === null || _h === void 0 ? void 0 : _h.markdownCommands;
        ...
        register() {
            this.subscribeObservable(this.ctx.behaviors.interaction.key, ({ code, key, modifiers }) => {
                ...
                if (binding_1.Binding.matchKey(b.keySpinAnimation, code, modifiers, key)) {
                    ...
                    if (name === 'off') {
                        commands_1.PluginCommands.Canvas3D.SetSettings(this.ctx, {
                            settings: {
                                trackball: {
                                    ...tp,
                                    animate: { name, params: {} }
                        ...
                        commands_1.PluginCommands.Canvas3D.SetSettings(this.ctx, {
                            settings: {
                                trackball: {
                                    ...tp,
                                    animate: { name, params: { speed: 0.1, axis: linear_algebra_1.Vec3.create(0, -1, 0) } }
                                }
                            }
                        });
                    }
                    ...
                    if (name === 'off') {
                        ...
                        commands_1.PluginCommands.Canvas3D.SetSettings(this.ctx, {
                            settings: {
                                trackball: {
                                    ...tp,
                                    animate: { name, params: { speed: 0.3, angle: 10, axis: linear_algebra_1.Vec3.create(0, -1, 0) } }
                                }
                            }
                        });
                    }
