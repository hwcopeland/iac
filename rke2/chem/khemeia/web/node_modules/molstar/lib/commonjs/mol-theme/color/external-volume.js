...
exports.ExternalVolumeColorThemeParams = {
    volume: param_definition_1.ParamDefinition.ValueRef((ctx) => {
        const volumes = ctx.state.data.select(selection_1.StateSelection.Generators.rootsOfType(objects_1.PluginStateObject.Volume.Data)).filter(c => { var _a; return (_a = c.obj) === null || _a === void 0 ? void 0 : _a.data; });
