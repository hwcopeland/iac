...
const Putty = {
    ...
    size_theme: (0, field_schema_1.OptionalField)((0, field_schema_1.literal)('uniform', 'uncertainty'), 'uniform', "Controls how the tube radius is determined. 'uniform' uses a constant radius scaled by size_factor. 'uncertainty' drives the radius from per-residue B-factor/RMSF values."),
};
const Surface = {
...
exports.MVSRepresentationParams = (0, params_schema_1.UnionParamsSchema)('type', 'Representation type', {
    ...
    putty: (0, params_schema_1.SimpleParamsSchema)(Putty),
});
