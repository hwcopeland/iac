...
const lookup3d_1 = require("./util/lookup3d.js");
const subset_builder_1 = require("./util/subset-builder.js");
const bonds_1 = require("./unit/bonds.js");
const symmetry_1 = require("./symmetry.js");
const properties_1 = require("./properties.js");
const compute_1 = require("./carbohydrates/compute.js");
const compute_2 = require("./coordination/compute.js");
...
const boundary_1 = require("./util/boundary.js");
const mapping_1 = require("./mapping.js");
class Structure {
    ...
    get coordination() {
        ...
        this.state.coordination = (0, compute_2.computeCoordination)(this);
        return this.state.coordination;
    }
    get models() {
...
(function (Structure) {
    ...
    function ofModel(model, props = {}) {
        ...
        for (let c = 0; c < chains.count; c++) {
            ...
            if (model_1.Model.isCoarseGrained(model))
                traits |= unit_1.Unit.Trait.CoarseGrained;
    ...
    function instances(s, transforms) {
        for (const t of transforms) {
            if (!linear_algebra_1.Mat4.isRotationAndTranslation(t, symmetry_operator_1.SymmetryOperator.RotationTranslationEpsilon)) {
                throw new Error('Only rotation/translation combination can be applied.');
            }
        }
        const units = [];
