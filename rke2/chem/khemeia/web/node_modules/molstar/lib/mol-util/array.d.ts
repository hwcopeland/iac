 ...
 */
import { Jsonable } from './json.js';
import { AssignableArrayLike, NumberArray } from './type-helpers.js';
...
export declare function arrayIsSorted<T>(array: ArrayLike<T>, compareFn: (a: T, b: T) => number): boolean;
...
export declare function arrayCopyOffset<T>(dst: AssignableArrayLike<T>, src: ArrayLike<T>, dstOffset: number, srcOffset: number, length: number): AssignableArrayLike<T>;
