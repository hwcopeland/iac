 ...
 */
export function addSphere(builder, radius, transform, group, options) {
    var _a, _b;
    const segments = (_a = options === null || options === void 0 ? void 0 : options.segments) !== null && _a !== void 0 ? _a : DefaultAddSphereOptions.segments;
    const circlesPerDim = (_b = options === null || options === void 0 ? void 0 : options.circlesPerDimension) !== null && _b !== void 0 ? _b : DefaultAddSphereOptions.circlesPerDimension;
...
function addCircle(builder, radius, offset, perpAxis, transform, group, segments) {
