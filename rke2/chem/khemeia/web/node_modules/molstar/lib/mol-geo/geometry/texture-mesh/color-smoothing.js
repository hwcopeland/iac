...
import { isNullTexture } from '../../../mol-gl/webgl/texture.js';
...
import { normalize_frag } from '../../../mol-gl/shader/compute/color-smoothing/normalize.frag.js';
...
import { accumulate_frag } from '../../../mol-gl/shader/compute/color-smoothing/accumulate.frag.js';
import { accumulate_vert } from '../../../mol-gl/shader/compute/color-smoothing/accumulate.vert.js';
import { isWebGL2 } from '../../../mol-gl/webgl/compat.js';
...
export function calcTextureMeshColorSmoothing(input, options, webgl, texture) {
...
export function applyTextureMeshColorSmoothing(values, options, webgl, colorTexture) {
...
export function applyTextureMeshOverpaintSmoothing(values, options, webgl, colorTexture) {
...
export function applyTextureMeshTransparencySmoothing(values, options, webgl, colorTexture) {
...
export function applyTextureMeshEmissiveSmoothing(values, options, webgl, colorTexture) {
...
export function applyTextureMeshSubstanceSmoothing(values, options, webgl, colorTexture) {
