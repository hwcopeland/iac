...
export declare function createVolumeCellLocationIterator(volume: Volume, key: number): LocationIterator;
export declare function createVolumeSliceCellLocationIterator(volume: Volume, key: number, image: Image): LocationIterator;
 ...
 */
export declare function createWrappedTensor(tensor: Tensor): Tensor;
/**
 ...
 * Only intended for isosurface construction.
 */
export declare function createWrappedVolume(volume: Volume): Volume;
export declare function createPeriodicVolume(volume: Volume, min: Vec3, max: Vec3): Volume;
