...
import { findUris, replaceUris, resolveUri, treeToString, windowUrl } from './tree/generic/tree-utils.js';
import { treeValidationIssues } from './tree/generic/tree-validation.js';
import { createMVSBuilder } from './tree/mvs/mvs-builder.js';
    ...
    async toMVSX(mvsData, options = {}) {
        ...
        if (!assets) {
            ...
            for (const uri of uris) {
                ...
                const content = (_a = cache[resolvedUri]) !== null && _a !== void 0 ? _a : (cache[resolvedUri] = await ajaxGet({ url: resolvedUri, type: 'binary' }).run());
                assets[uri] = content;
            }
        }
