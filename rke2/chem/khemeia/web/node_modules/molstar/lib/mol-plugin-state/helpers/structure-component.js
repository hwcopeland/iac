...
import { StructureElement, Structure, StructureSelection as Sel, Queries, QueryContext, Model } from '../../mol-model/structure.js';
...
export function updateStructureComponent(a, b, oldParams, newParams, cache) {
    ...
    switch (newParams.type.name) {
        case 'static': {
            ...
            if (!b.data.model)
                return StateTransformer.UpdateResult.Unchanged; // .model can be undefined, when a substructure is empty -> doesn't need remapping
