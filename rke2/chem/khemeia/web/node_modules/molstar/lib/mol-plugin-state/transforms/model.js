 ...
 */
import { parseDcd } from '../../mol-io/reader/dcd/parser.js';
import { parseGRO } from '../../mol-io/reader/gro/parser.js';
import { parsePDB } from '../../mol-io/reader/pdb/parser.js';
import { Vec3 } from '../../mol-math/linear-algebra.js';
import { shapeFromPly } from '../../mol-model-formats/shape/ply.js';
import { coordinatesFromDcd } from '../../mol-model-formats/structure/dcd.js';
import { trajectoryFromGRO } from '../../mol-model-formats/structure/gro.js';
import { trajectoryFromCCD, trajectoryFromMmCIF } from '../../mol-model-formats/structure/mmcif.js';
import { trajectoryFromPDB } from '../../mol-model-formats/structure/pdb.js';
import { topologyFromPsf } from '../../mol-model-formats/structure/psf.js';
import { Model, Queries, QueryContext, Structure, StructureElement, StructureSelection as Sel, ArrayTrajectory } from '../../mol-model/structure.js';
...
import { createStructureComponent, StructureComponentParams, updateStructureComponent } from '../helpers/structure-component.js';
...
import { parseMol } from '../../mol-io/reader/mol/parser.js';
import { trajectoryFromMol } from '../../mol-model-formats/structure/mol.js';
import { trajectoryFromCifCore } from '../../mol-model-formats/structure/cif-core.js';
import { trajectoryFromCube } from '../../mol-model-formats/structure/cube.js';
import { parseMol2 } from '../../mol-io/reader/mol2/parser.js';
import { trajectoryFromMol2 } from '../../mol-model-formats/structure/mol2.js';
import { parseXtc } from '../../mol-io/reader/xtc/parser.js';
import { coordinatesFromXtc } from '../../mol-model-formats/structure/xtc.js';
import { parseXyz } from '../../mol-io/reader/xyz/parser.js';
import { trajectoryFromXyz } from '../../mol-model-formats/structure/xyz.js';
import { UnitStyles } from '../../mol-io/reader/lammps/schema.js';
import { parseLammpsData } from '../../mol-io/reader/lammps/data/parser.js';
import { trajectoryFromLammpsData } from '../../mol-model-formats/structure/lammps-data.js';
import { parseLammpsTrajectory } from '../../mol-io/reader/lammps/traj/parser.js';
import { coordinatesFromLammpsTrajectory, trajectoryFromLammpsTrajectory } from '../../mol-model-formats/structure/lammps-trajectory.js';
import { parseSdf } from '../../mol-io/reader/sdf/parser.js';
import { trajectoryFromSdf } from '../../mol-model-formats/structure/sdf.js';
import { assertUnreachable } from '../../mol-util/type-helpers.js';
import { parseTrr } from '../../mol-io/reader/trr/parser.js';
import { coordinatesFromTrr } from '../../mol-model-formats/structure/trr.js';
import { parseNctraj } from '../../mol-io/reader/nctraj/parser.js';
import { coordinatesFromNctraj } from '../../mol-model-formats/structure/nctraj.js';
import { topologyFromPrmtop } from '../../mol-model-formats/structure/prmtop.js';
import { topologyFromTop } from '../../mol-model-formats/structure/top.js';
...
export async function getTrajectory(ctx, obj, coordinates) {
...
const TrajectoryFromPDB = PluginStateTransform.BuiltIn({
    ...
    to: SO.Molecule.Trajectory,
    params: {
        variant: PD.Select('pdb', PD.arrayToOptions(['pdb', 'pdbqt', 'pqr'])),
    }
})({
    apply({ a, params }) {
