 ...
 */
import { EnumCol, StrCol, IntCol, ListCol, FloatCol, CoordCol, MatrixCol, VectorCol } from './schema.js';
import { parseImportGet } from './helper.js';
...
export function generateSchema(frames, imports = new Map()) {
    const tables = {};
