...
import { CCD_Schema } from '../../mol-io/reader/cif/schema/ccd.js';
export async function ensureAvailable(path, url, forceDownload = false) {
...
export async function ensureDataAvailable(options) {
...
export async function readFileAsCollection(path, schema) {
...
export function getEncodedCif(name, database, binary = false) {
