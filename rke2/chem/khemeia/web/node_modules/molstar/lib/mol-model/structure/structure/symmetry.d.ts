...
declare namespace StructureSymmetry {
    ...
    function UnitEquivalenceBuilder(): import("../../../mol-data/util.js").EquivalenceClassesImpl<number, Unit>;
    function computeTransformGroups(s: Structure): ReadonlyArray<Unit.SymmetryGroup>;
    function computeChildAwareTransformGroups(s: Structure): ReadonlyArray<Unit.SymmetryGroup>;
