...
import { hash2 } from '../../../mol-data/util/hash-functions.js';
...
(function (StructureSymmetry) {
    ...
    function computeChildAwareTransformGroups(s) {
        ...
        const groups = EquivalenceClasses((u) => { var _a; return hash2(Unit.hashUnit(u), (_a = childGroupIndex.get(u.id)) !== null && _a !== void 0 ? _a : -1); }, (a, b) => areUnitsEquivalent(a, b) && childGroupIndex.get(a.id) === childGroupIndex.get(b.id));
        for (const u of s.units)
            groups.add(u.id, u);
        const ret = [];
        for (const eqUnits of groups.groups) {
