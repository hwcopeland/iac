...
export const ExternalVolumeColorThemeParams = {
    volume: PD.ValueRef((ctx) => {
        const volumes = ctx.state.data.select(StateSelection.Generators.rootsOfType(PluginStateObject.Volume.Data)).filter(c => { var _a; return (_a = c.obj) === null || _a === void 0 ? void 0 : _a.data; });
