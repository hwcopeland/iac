...
export function volumeFromSegmentationData(source, params) {
    return Task.create('Create Segmentation Volume', async (ctx) => {
        ...
        const cell = SpacegroupCell.create(info.spacegroup_number.value(0) || 'P 1', Vec3.ofArray(info.spacegroup_cell_size.value(0)), Vec3.scale(Vec3(), Vec3.ofArray(info.spacegroup_cell_angles.value(0)), Math.PI / 180));
        ...
        Volume.Segmentation.set(v, { segments, sets, bounds, labels: (_a = params === null || params === void 0 ? void 0 : params.segmentLabels) !== null && _a !== void 0 ? _a : {} });
        return v;
    });
}
//
