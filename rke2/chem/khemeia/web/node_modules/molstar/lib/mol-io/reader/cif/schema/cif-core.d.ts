...
export declare const CifCore_Aliases: {
    ...
    'chemical_formula.iupac': string[];
    'space_group.it_number': string[];
    'space_group.name_h-m_alt': string[];
    'space_group.name_h-m_full': string[];
    'space_group.name_hall': string[];
