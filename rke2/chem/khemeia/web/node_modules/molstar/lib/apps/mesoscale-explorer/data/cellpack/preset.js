...
import { MesoscaleGroup, MesoscaleState, getDistinctBaseColors, getDistinctGroupColors, getGraphicsModeProps, getMesoscaleGroupParams } from '../state.js';
import { CellpackAssembly, CellpackStructure } from './model.js';
...
export async function createCellpackHierarchy(plugin, trajectory) {
    var _a, _b, _c;
