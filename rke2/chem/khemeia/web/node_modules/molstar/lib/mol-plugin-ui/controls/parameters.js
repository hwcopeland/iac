...
import { ColorListOptions, ColorListOptionsScale, ColorListOptionsSet, getColorListFromName } from '../../mol-util/color/lists.js';
import { memoize1, memoizeLatest } from '../../mol-util/memoize.js';
import { getPrecision } from '../../mol-util/number.js';
import { ParamDefinition as PD } from '../../mol-util/param-definition.js';
import { camelCaseToWords } from '../../mol-util/string.js';
import { PluginReactContext, PluginUIComponent } from '../base.js';
import { ActionMenu } from './action-menu.js';
import { ColorOptions, ColorValueOption, CombinedColorControl } from './color.js';
import { Button, ControlGroup, ControlRow, ExpandGroup, IconButton, TextInput, ToggleButton } from './common.js';
import { ArrowDownwardSvg, ArrowDropDownSvg, ArrowRightSvg, ArrowUpwardSvg, BookmarksOutlinedSvg, CheckSvg, ClearSvg, DeleteOutlinedSvg, HelpOutlineSvg, Icon, TuneSvg, WarningSvg } from './icons.js';
import { legendFor } from './legend.js';
import { LineGraphComponent } from './line-graph/line-graph-component.js';
import { Slider, Slider2 } from './slider.js';
import { getColorGradient, getColorGradientBanded } from '../../mol-util/color/utils.js';
...
function TextCtrl({ props, placeholder, update }) {
    ...
    if (props.param.multiline) {
        return _jsx("div", { className: 'msp-control-text-area-wrapper', children: _jsx("textarea", { value: value !== null && value !== void 0 ? value : '', placeholder: placeholder, disabled: props.isDisabled, onChange: onChange, onBlur: onBlur, onKeyDown: onKeyDown, onCompositionStart: () => setComposition(true), onCompositionEnd: onCompositionEnd }) });
    }
    else {
        return _jsx("input", { type: 'text', value: value !== null && value !== void 0 ? value : '', placeholder: placeholder, disabled: props.isDisabled, onChange: onChange, onBlur: onBlur, onKeyDown: onKeyDown, onCompositionStart: () => setComposition(true), onCompositionEnd: onCompositionEnd });
    }
}
...
export class SelectControl extends React.PureComponent {
    ...
    renderControl() {
        ...
        const icon = this.props.param.cycle
            ...
            : void 0;
        return _jsx(ToggleButton, { disabled: this.props.isDisabled, style: { textAlign, overflow: 'hidden', textOverflow: 'ellipsis' }, label: label, title: label, icon: icon, toggle: toggle, isSelected: this.state.showOptions, className: 'msp-select-toggle' });
    }
    renderAddOn() {
...
export class Vec3Control extends React.PureComponent {
    ...
    render() {
        ...
        return _jsxs(_Fragment, { children: [_jsx(ControlRow, { label: label, control: _jsx("button", { onClick: this.toggleExpanded, disabled: this.props.isDisabled, children: _jsx("div", { title: value, className: 'msp-no-overflow', style: { display: 'block' }, children: value }) }) }), this.state.isExpanded && _jsx("div", { className: 'msp-control-offset', children: _jsx(ParameterControls, { params: this.components, values: v, onChange: this.componentChange, onEnter: this.props.onEnter }) })] });
    }
}
export class Mat4Control extends React.PureComponent {
    ...
    render() {
        ...
        const label = this.props.param.label || camelCaseToWords(this.props.name);
        return _jsxs(_Fragment, { children: [_jsx(ControlRow, { label: label, control: _jsx("button", { onClick: this.toggleExpanded, disabled: this.props.isDisabled, children: _jsx("div", { className: 'msp-no-overflow', style: { display: 'block' }, children: '4\u00D74 Matrix' }) }) }), this.state.isExpanded && _jsxs("div", { className: 'msp-control-offset', children: [this.grid, _jsx(ParameterControls, { params: this.components, values: v, onChange: this.componentChange, onEnter: this.props.onEnter })] })] });
    }
}
...
export class GroupControl extends React.PureComponent {
    ...
    pivoted() {
        ...
        if (!this.state.isExpanded) {
            return _jsxs("div", { className: 'msp-mapped-parameter-group', children: [ctrl, _jsx(IconButton, { svg: TuneSvg, onClick: this.toggleExpanded, toggleState: this.state.isExpanded, title: `More Options`, style: { opacity: 0.7 } })] });
        }
