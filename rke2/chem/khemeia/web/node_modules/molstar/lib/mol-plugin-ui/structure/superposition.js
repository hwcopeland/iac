...
import { QueryContext, StructureElement, StructureProperties, StructureSelection } from '../../mol-model/structure.js';
import { alignAndSuperpose, superpose } from '../../mol-model/structure/structure/util/superposition.js';
import { alignAndSuperposeWithSIFTSMapping } from '../../mol-model/structure/structure/util/superposition-sifts-mapping.js';
...
import { elementLabel, structureElementStatsLabel } from '../../mol-theme/label.js';
import { ParamDefinition as PD } from '../../mol-util/param-definition.js';
import { stripTags } from '../../mol-util/string.js';
import { CollapsableControls, PurePluginUIComponent } from '../base.js';
import { Button, IconButton, ToggleButton } from '../controls/common.js';
import { ArrowDownwardSvg, ArrowUpwardSvg, DeleteOutlinedSvg, HelpOutlineSvg, Icon, SuperposeAtomsSvg, SuperposeChainsSvg, SuperpositionSvg, TuneSvg } from '../controls/icons.js';
import { ParameterControls } from '../controls/parameters.js';
...
export class SuperpositionControls extends PurePluginUIComponent {
    ...
    addByTMAlign() {
        const entries = this.chainEntries;
        return _jsxs(_Fragment, { children: [entries.length > 0 && _jsx("div", { className: 'msp-control-offset', children: entries.map((e, i) => this.lociEntry(e, i)) }), entries.length < 2 && _jsx("div", { className: 'msp-control-offset msp-help-text', children: _jsxs("div", { className: 'msp-help-description', children: [_jsx(Icon, { svg: HelpOutlineSvg, inline: true }), "Add 2 or more selections", this.toggleHint(), " from separate structures. Selections must be limited to single polymer chains. TM-align performs structure-based alignment independent of sequence."] }) }), entries.length > 1 && _jsx(Button, { title: 'Superpose structures using TM-align (structure-based alignment).', className: 'msp-btn-commit msp-btn-commit-on', onClick: this.superposeTMAlign, style: { marginTop: '1px' }, children: "TM-align Superpose" })] });
    }
